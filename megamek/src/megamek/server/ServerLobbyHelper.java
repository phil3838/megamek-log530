...
public class ServerLobbyHelper {
     ...
     * <P>NOTE: This is a simplified unload that is only valid in the lobby!
     */
    public static HashSet<Entity> lobbyUnloadOthers(Game game, Collection<Entity> entities) {
        HashSet<Entity> result = new HashSet<>();
        for (Entity entity: entities) {
     ...
     */
    public static HashSet<Entity> lobbyDisembark(Game game, Entity entity) {
     ...
     * <P>NOTE: This is a simplified disembark that is only valid in the lobby!
     */
    public static HashSet<Entity> lobbyDisembarkOthers(Game game, Entity entity, Collection<Entity> entities) {
        HashSet<Entity> result = new HashSet<>();
     ...
     * <P>NOTE: This is a simplified disembark that is only valid in the lobby!
     */
    public static void lobbyDisembarkEnemy(Game game, Entity entity) {
        if (entity.getTransportId() != Entity.NONE) {
            Entity carrier = game.getEntity(entity.getTransportId());
            if (carrier == null) {
                entity.setTransportId(Entity.NONE);
     ...
     */
    public static Packet createForceUpdatePacket(Collection<Force> changedForces) {
     ...
     * forceId changed.
     */
    public static Packet createForceUpdatePacket(Collection<Force> changedForces, Collection<Entity> entities) {
     ...
     */
    public static boolean isEditable(Force force, Game game, Player sender) {
